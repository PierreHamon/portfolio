    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 w-[95%] md:w-[50%] mx-auto my-6">
            ...
            <div className="flex flex-col items-center gap-3 mb-6">
                ...
                {currentCover && (
                    <img 
                        className='aspect-square object-cover w-[70%] h- md:w-[50%] object-cover rounded-lg shadow-md border-2 border-gray-100' 
                        src={currentCover} 
            ...
            <div className="flex items-center justify-center gap-4">
                ...
                <div className="flex items-center justify-center md:justify-start gap-3 w-1/3">
                    {/* Bouton Précédent */}
                    <button
                ...
                <div className="hidden md:flex items-center gap-3 bg-gray-50 px-4 py-2 rounded-full border border-gray-100 shadow-inner max-w-[180px] w-1/3">
