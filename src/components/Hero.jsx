...
function Hero() {
  return (
    <>
  <section id="presentation" className="flex flex-col-reverse items-center md:flex-row bg-background-second mt-5 pt-5 md:pt-10 pb-10 ps-[10%] pe-[5%] justify-between">
