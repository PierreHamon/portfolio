...
function App() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-background text-slate-900 overflow-x-hidden">
      ...
      <div className="fixed border-b-1 border-border md:relative top-0 py-5 md:py-0 flex flex-row w-full bg-background md:w-auto justify-between z-50">
        <a onClick={(e) => {
          e.preventDefault(); // Empêche la page de remonter tout en haut
          setIsDark(!isDark);
          }}
        className="flex bg-white-menu p-2 px-5 mx-6 md:shadow-sm rounded-lg hover:bg-grey-bg hover:text-purple-second"
        >
          {isDark ? (
