...
function Header() {
  ...
  return (
    <header id="header" className="flex items-center justify-between font-open-sans font-bold w-full mt-5 relative ">
      <div></div>
      ...
      <div className="flex flex-row w-full md:w-auto justify-between">
        <a onClick={(e) => {
          e.preventDefault(); // Empêche la page de remonter tout en haut
          setIsDark(!isDark);
          }}
        className="flex bg-white-menu p-2 px-5 mx-6 shadow-sm rounded-lg hover:bg-grey-bg hover:text-purple-second"
        >
          {isDark ? (
        ...
        <i className="flex md:hidden p-2 px-5 mx-6"
        ...
        <div className={`absolute md:hidden top-17 py-5 left-0 w-full bg-white flex flex-col items-center
