...
function Parcours() {
  ...
  return (
    <section ref={sectionRef} id="parcours" className="scroll-m-[2vh] md:scroll-m-[0vh]">
      ...
      <div className="relative w-11/12 max-w-[1500px] mx-auto">
          <ElementParcours 
            ...
            image={logo_callo}
            lien="https://lyceemarcelcallo.org/"
          />
        <ElementParcours 
          ...
          image={logo_iut}
          reverse={true}
          lien="https://iut-lannion.univ-rennes.fr/"
        />
        <ElementParcours 
          ...
          image={logo_cil}
          lien="https://www.cil-lamballe.com/"
        />
      </div>
    </section>
  );
